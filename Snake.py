...
class SnakeApp:
    def __init__(self, root):
        ...
        self.colores=["blue","red","white","pink"]
    ...
    def actualizar_tablero(self):
        ...
        for x, y in self.snake:
            self.canvas.create_rectangle(x * TAMANO_CELDA, y * TAMANO_CELDA,
                                         (x + 1) * TAMANO_CELDA, (y + 1) * TAMANO_CELDA, fill=random.choice(self.colores))
        
        x, y = self.comida
        self.canvas.create_oval(x * TAMANO_CELDA, y * TAMANO_CELDA,
                                (x + 1) * TAMANO_CELDA, (y + 1) * TAMANO_CELDA, fill="pink")
        
        self.canvas.create_text(50, 10, text=f"Puntuación: {self.puntuacion}", fill="blue")
    ...
    def mostrar_fin_juego(self):
        self.canvas.delete("all")
        self.canvas.create_text(ANCHO * TAMANO_CELDA // 6, ALTO * TAMANO_CELDA // 6,
